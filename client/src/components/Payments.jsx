          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  setFormData(prev => ({
                    ...prev,
                    method: nextMethod,
                    referenceNumber: generateReferenceNumber(nextMethod)
                  }));
                }}
              >
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <input
                  type="text"
                  className="flex-1 p-2 bg-background rounded border border-border text-textPrimary font-mono text-sm opacity-75"
                  value={formData.referenceNumber}
                  readOnly
                  placeholder="Auto-generated based on payment method"
                />
                <span className="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded whitespace-nowrap">Auto-Generated</span>
              </div>
              <p className="text-xs text-textSecondary mt-1">Automatically generated from payment method. Cannot be changed manually.</p>
            </div>
            <div>
